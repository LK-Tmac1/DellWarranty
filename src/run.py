...
from py.constant import error_message, html_error_input, html_home, html_confirm_job
import subprocess
...
def submit_job():
	...
	valid_code = verify_job_parameter(parent_path + "dell_config.yml", password, svc_L)
	if valid_code == 0:
